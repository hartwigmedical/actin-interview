...
class ProteinIsLostByIhcTest {
    ...
    private val passingTest = ihcTest(item = PROTEIN, scoreText = IhcTestEvaluationConstants.EXACT_NEGATIVE_TERMS.first())
    private val wrongTest = ihcTest(item = PROTEIN, scoreText = IhcTestEvaluationConstants.EXACT_POSITIVE_TERMS.first())
